...
contract PlonkVerifier is IVerifier {
  ...
  uint256 private constant G2_SRS_1_X_0 = 1876678078093755354493972302771539322152602473341379791709804652510259141394;
  uint256 private constant G2_SRS_1_X_1 = 10922859444189303793236219282651888296811102621676951644409692090727476573682;
  uint256 private constant G2_SRS_1_Y_0 = 4278406271339879532291375448274206716449321239934990298759560559289339602303;
  uint256 private constant G2_SRS_1_Y_1 = 8124366685320835371601170885019194661339885637094220411317206219980128374497;
  ...
  uint256 private constant VK_DOMAIN_SIZE = 2;
  uint256 private constant VK_INV_DOMAIN_SIZE = 10944121435919637611123202872628637544274182200208017171849102093287904247809;
  uint256 private constant VK_OMEGA = 21888242871839275222246405745257275088548364400416034343698204186575808495616;
  uint256 private constant VK_QL_COM_X = 20040100024678602368054278192093893752625513266178178954724074959709013589177;
  uint256 private constant VK_QL_COM_Y = 14210192708449310530596916231346744099771358847513968469292514685204458635505;
  uint256 private constant VK_QR_COM_X = 11626810629513089426831336710907082770229861233301920289761650079230298333758;
  uint256 private constant VK_QR_COM_Y = 16252837261911534405010460780518955066276107934726851559659559022067431783801;
  uint256 private constant VK_QM_COM_X = 0;
  uint256 private constant VK_QM_COM_Y = 0;
  uint256 private constant VK_QO_COM_X = 0;
  uint256 private constant VK_QO_COM_Y = 0;
  uint256 private constant VK_QK_COM_X = 0;
  uint256 private constant VK_QK_COM_Y = 0;
  
  uint256 private constant VK_S1_COM_X = 3231673806907944779932101995079436676678530154759453005961146751046730844585;
  uint256 private constant VK_S1_COM_Y = 15984336950455649074892220351063777348548468004980053390408923717000417308046;
  
  uint256 private constant VK_S2_COM_X = 7562289337448897582625490205898870840052913007667654014764850879895633240272;
  uint256 private constant VK_S2_COM_Y = 18635111399705882380036424037816728448652750278124081315048171351683404540203;
  
  uint256 private constant VK_S3_COM_X = 18814485618521573777157369372978979995025690432819612676504920150264451247869;
  uint256 private constant VK_S3_COM_Y = 586325203862181407098184002538977947902590978363402621774912282126703704033;
